...
const NOTE_SECTIONS = [
  {
    ...
    placeholder: [
      '[ 항공 예약번호 ]',
      'OZ0551  ICN→IST  7/1 10:25',
      'OZ0552  IST→ICN  7/11 17:30',
      '',
      '[ 공항 → 숙소 이동 ]',
      '이스탄불: 하바이스트 버스 / 공항택시 ~700TL',
      '카파도키아: 공항픽업 예약 필요',
      '안탈리아: 호텔 셔틀 or 택시',
      '',
      '[ 국내선 ]',
      'TK2006  IST→NAV  7/5 13:45 (예약번호: )',
      'XQ7033  ASR→AYT  7/7 21:20 (예약번호: )',
    ].join('\n'),
  },
  {
    id: 'hotel',
